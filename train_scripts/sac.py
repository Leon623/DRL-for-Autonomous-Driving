...
def main():
    ...
    params = {
        ...
        'lidar_bin': 0.250,  # bin size of lidar sensor (meter) # bilo je 0.125
    ...
    model = SAC(CnnPolicy, env, verbose=1,tensorboard_log="./tensor_usporedba/");

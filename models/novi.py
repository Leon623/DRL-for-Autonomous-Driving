...
def main():
  ...
  model = SAC("MultiInputPolicy", env, verbose=1,buffer_size=10000, tensorboard_log="./zavrsni-usporedba/")
  model.learn(total_timesteps=25000,log_interval=1)

  model.save("modeli/SAC")
  model = SAC.load("modeli/SAC",env=env,verbose=1, tensorboard_log="./zavrsni-modeli/")

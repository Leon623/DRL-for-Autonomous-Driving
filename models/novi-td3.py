...
def main():
  ...
  model = TD3("MultiInputPolicy", env, verbose=1,buffer_size=10000, tensorboard_log="./zavrsni-usporedbe/",action_noise = action_noise);
  model.learn(total_timesteps=25000,log_interval=1)

  model.save("modeli/TD3")
  model = TD3.load("modeli/TD3",env=env,verbose=1,buffer_size=10000, tensorboard_log="./zavrsni-modeli/",action_noise = action_noise);
